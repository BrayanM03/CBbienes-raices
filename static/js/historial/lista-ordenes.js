$(document).ready(function () {
  ...
  let sucursal_id = $("#user-data").attr("id_sucursal")
    tabla = $('#example').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: '../servidor/historial/tabla-ventas.php',//
        ...
        columns:  [
            { data:0, title:'Folio' },
            { data:null, title:'Fecha', render:(row)=>{
                return `${row[1]} - ${row[2]}`
            } },
            { data:4, title:'Cliente' },
            { data:5, title:'Telefono' },
            { data:6, title:'Dirección' },
            { data:7, title:'Correo' },
            { data:8, title:'Usuario' },
            { data:10, title:'Total' },
            { data:11, title:'Comentario'},
