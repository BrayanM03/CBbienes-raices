					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="img/logo-cb.png" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark" id="user-data" id_sucursal="<?php echo $_SESSION["sucursal_id"] ?>" id_user="<?php echo $_SESSION["id"] ?>"><?php echo $_SESSION["nombre"]. " ". $_SESSION["apellido"]?></span>
							</a>
